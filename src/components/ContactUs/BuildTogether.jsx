          ...
          <SlideInLeft delay={0.5} duration={0.8}>
            <div className="flex flex-col justify-center items-start w-full lg:w-[712px]">
              <div className="flex flex-col items-start gap-[20px] lg:gap-[28px] w-full">
                ...
                {/* Contact Us Button */}
                <motion.button 
                  className="flex items-center justify-center px-5 sm:px-6 md:px-7 py-3 sm:py-3.5 md:py-4 gap-[10px] bg-[#1D3357] text-white font-outfit font-semibold text-sm sm:text-base rounded-[35px] border-none cursor-pointer whitespace-nowrap mt-4"
