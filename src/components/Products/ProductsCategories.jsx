...
import { fadeInUp, staggerContainer, slideInFromBottom } from '../../utils/animations.jsx';
  ...
  const categories = [
    {
      ...
      image: "/images/Products/tvastafurniture1.jpg",
    ...
    },
    {
      ...
      image: "/images/Products/tvastafurniture2.jpg",
    ...
    },
    {
      ...
      image: "/images/Products/tvastafurniture3.jpg",
      ...
      <div className="flex flex-col items-center gap-[60px] w-full max-w-[1280px]">
        ...
        >
          {categories.map((category, index) => (
            <div 
              key={category.id}
              className="flex flex-col justify-between items-start p-4 gap-[20px] w-full h-[350px] md:h-[400px] rounded-[24px] overflow-hidden relative group cursor-pointer hover:shadow-xl transition-all duration-300"
              style={{ 
