    ...
    <section className="flex flex-col md:flex-row items-center gap-[40px] md:gap-[60px] w-full max-w-[1280px] px-4 md:px-8">
      ...
      <SlideInLeft delay={0.2} duration={0.8} className="w-full md:w-[508px] h-[250px] md:h-[350px] rounded-[24px] overflow-hidden order-2 md:order-1">
        <AnimatedCard className="w-full h-full" whileHover={{ scale: 1.05 }}>
          <img 
            src="/images/Products/downloadbrochure.jpg" 
      ...
      {/* Content */}
      <SlideInRight delay={0.4} duration={0.8} className="flex flex-col justify-center items-start py-6 gap-[10px] w-full md:flex-1 order-1 md:order-2">
        <div className="flex flex-col items-start gap-[28px] w-full">
          ...
          <FadeIn delay={0.8} duration={0.8}>
            <AnimatedButton 
              className="flex items-center justify-center px-7 py-4 gap-[10px] bg-[#E63946] rounded-[20px] hover:bg-[#d63384] transition-colors duration-300 group"
            ...
            >
              ...
              <div className="w-[20px] h-[20px] bg-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-[12px] h-[12px] text-[#E63946]" fill="currentColor" viewBox="0 0 20 20">
