...
import { FadeIn, SlideInLeft, SlideInRight, StaggeredList, AnimatedCard } from '../../utils/animations.jsx';
        ...
        <div className="relative w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 items-start">
            ...
            <SlideInLeft delay={0.3} duration={0.8}>
              <div className="relative col-span-1 sm:col-span-2 lg:col-span-1 order-1 lg:order-1">
                <AnimatedCard 
                  ...
                  whileHover={{ y: -10, boxShadow: "0px_15px_35px_rgba(13,25,45,0.5)" }}
                >
            ...
            {products.slice(1).map((product, index) => (
              <SlideInRight key={product.id} delay={0.4 + (index * 0.1)} duration={0.8}>
                <div className={`relative w-full h-[300px] md:h-[360px] rounded-[12px] overflow-hidden group cursor-pointer transition-all duration-300 ${
