    ...
    <div className="flex flex-col items-center gap-14 w-full max-w-[1240px] px-4 lg:px-0">
      ...
      <FadeIn delay={0.2} duration={0.8}>
        <div className="flex flex-col items-center gap-[10px] w-full text-center">
          <h2 className="font-outfit font-semibold text-[32px] md:text-[48px] leading-[140%] text-[#0D192D] w-full">
            Why Choose 3D Construction
          </h2>
          <p className="max-w-[804px] font-outfit font-normal text-[18px] md:text-[24px] leading-[30px] text-[#1D3357]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 w-full">
            ...
            >
              <div className="relative w-full h-[250px] lg:h-[318px] rounded-[10px] overflow-hidden group">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-70 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <p className="text-white font-outfit font-medium text-[22px] leading-[120%] text-center px-6">
                    Complete homes and infrastructure in days, not months. Ideal for urgent or large-scale needs.
                  </p>
                </div>
              </div>
              <h3 className="font-outfit font-semibold text-[20px] lg:text-[26px] leading-[120%] text-[#0D192D] w-full text-center lg:text-left">
                Faster Time to Build
              </h3>
            </motion.div>
          </SlideInLeft>
          ...
          <SlideInRight delay={0.6} duration={0.8}>
            ...
            >
              ...
              <h3 className="font-outfit font-semibold text-[20px] lg:text-[26px] leading-[120%] text-[#0D192D] w-full">
                Design Without Limits
              </h3>
            </motion.div>
          </SlideInRight>
