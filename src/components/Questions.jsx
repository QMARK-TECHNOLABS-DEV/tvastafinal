      ...
      <SlideInUp delay={0.3}>
        ...
        >
          ...
          <div className="w-[30px] h-[30px] flex items-center justify-center">
            <svg className="w-full h-full text-white transition-transform duration-300 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="font-outfit font-normal text-[20px] leading-[25px] text-white w-[211px] h-[25px] flex items-center">
