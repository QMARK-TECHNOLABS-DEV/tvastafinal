            ...
            <div className="flex flex-col px-6 py-4 space-y-4">
              ...
              <Link to="/" onClick={() => setIsMobileMenuOpen(false)}>
                <motion.div 
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <span className="text-[#0D192D] font-outfit font-medium text-base">Careers</span>
                </motion.div>
              </Link>
              ...
              <Link to="/" onClick={() => setIsMobileMenuOpen(false)}>
                <motion.div 
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <span className="text-[#0D192D] font-outfit font-medium text-base">Marketplace</span>
                </motion.div>
              </Link>
              ...
              <Link to="/" onClick={() => setIsMobileMenuOpen(false)}>
                <motion.div 
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <span className="text-[#0D192D] font-outfit font-medium text-base">Blog</span>
                </motion.div>
              </Link>
