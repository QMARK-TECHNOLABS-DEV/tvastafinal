      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-[20px] w-full justify-items-center">
        {reasons.map((reason, index) => (
          <SlideInUp key={index} delay={0.4 + index * 0.1} duration={0.6}>
            <AnimatedCard 
              className="box-border w-full max-w-[320px] sm:w-full sm:max-w-[280px] lg:max-w-[300px] xl:w-[305px] h-[360px] sm:h-[380px] lg:h-[400px] bg-white border border-black/10 backdrop-blur-[24px] rounded-[24px] flex flex-col items-center justify-center p-4 sm:p-5 lg:p-6"
